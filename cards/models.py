...
class Category(models.Model):
    name = models.CharField("Название категорий", max_length=50)
...
class ItemImages(models.Model):
    ...
    image = models.ImageField("Изоброжение", upload_to="item")
    image_mobile = models.ImageField("Изоброжение",upload_to="item")
